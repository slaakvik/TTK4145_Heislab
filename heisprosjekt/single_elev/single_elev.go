...
func ButtonsAndRequests(masterPort string, elevatorID string, elevUpdateRealtimeCh <-chan elevator.Elevator,
...
func OrderExecution(masterPort string, elevatorId string, elevUpdateRealtimeCh chan<- elevator.Elevator,
